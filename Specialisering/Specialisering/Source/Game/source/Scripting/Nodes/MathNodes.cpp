...
{
	Tga::ScriptNodeTypeRegistry::RegisterType<Converter2>("Math/Converter", "Simple math functions float");
	Tga::ScriptNodeTypeRegistry::RegisterType<Converter2>("Math/Converter4", "Simple math functions for float4");
...
Tga::ScriptLinkData Tga::Converter2::ReadPin(Tga::ScriptExecutionContext& aContext, ScriptPinId) const
{
...
ParsedData Tga::Converter2::ParseInputPin(Tga::ScriptExecutionContext& aContext, ScriptPinId) const
{
...
void Tga::Converter2::LoadFromJson(const ScriptJson& aJson)
{
	myConverterMode = (ConverterMode)aJson.json["mode"];
}
void Tga::Converter2::WriteToJson(ScriptJson& aJson) const
{
	aJson.json["mode"] = (int)myConverterMode;
}
void Tga::Converter2::CustomUi(float aSizeMod)
{
