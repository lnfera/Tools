...
AmbientLight::AmbientLight() : Light(Matrix4x4f{}, {}, {}) {}
AmbientLight::AmbientLight(const Color& aColor, float aIntensity) : Light(Matrix4x4f{}, aColor, aIntensity) {}
AmbientLight::AmbientLight(std::wstring& someCubemapLocation, const Color& aColor, float aIntensity) : Light(Matrix4x4f{}, aColor, aIntensity) { SetCubemap(someCubemapLocation); }
