...
namespace Tga
{
	...
	template <class T> Vector4<T> operator/(const Vector4<T>& aVector, const T& aScalar);
	template <class T> Vector4<T> operator*(const Vector4<T>& aVector, const Vector4<T>& aVector2);
	template <class T> Vector4<T> operator/(const Vector4<T>& aVector, const Vector4<T>& aVector2);
	...
	template <class T> void operator/=(Vector4<T>& aVector, const T& aScalar);
	template <class T> bool operator==(const Vector4<T>&, const Vector4<T>&);
	template <class T> bool operator!=(const Vector4<T>&, const Vector4<T>&);
...
#pragma region OperatorDefinitions
	...
	template <class T>
	Vector4<T> operator*(const Vector4<T>& aVector, const Vector4<T>& aVector2)
	{
		return Vector4<T>(aVector.X * aVector2.x, aVector.Y * aVector2.Y, aVector.Z * aVector2.Z, aVector.W * aVector2.W);
	}
	template <class T>
	Vector4<T> operator/(const Vector4<T>& aVector, const Vector4<T>& aVector2)
	{
