...
namespace Tga
{
	...
	public:
		...
		static Matrix2x2<T> CreateFromRotation(const T aAngleInRadians);
		static Matrix2x2<T> CreateFromScale(Vector2<T> aScalarVector);
...
#pragma region Static Functions
	...
	template<typename T>
	inline Matrix2x2<T> Matrix2x2<T>::CreateFromRotation(const T aAngleInRadians)
	{
	...
	template<typename T>
	inline Matrix2x2<T> Matrix2x2<T>::CreateFromScale(Vector2<T> aScaleVector)
	{
		Matrix2x2<T> result;
