...
#pragma region Static Functions
	...
	/*template<typename T>
	void Matrix4x4<T>::SetScaleRotation(const Matrix3x3<T>& aMatrix)
	{
		myXAxis = { aMatrix[0],aMatrix[1],aMatrix[2] };
		myYAxis = { aMatrix[3],aMatrix[4],aMatrix[5] };
		myZAxis = { aMatrix[6],aMatrix[7],aMatrix[8] };
	}*/
